...
from .temba import temba_sync_contact, temba_pull_contacts
...
def push_contact_change(contact_id, change_type):
    ...
    temba_sync_contact(org, contact, change_type, region_uuids)
...
def sync_org_contacts(org_id):
    ...
    created, updated, deleted = temba_pull_contacts(org, primary_groups, Region, Contact)
