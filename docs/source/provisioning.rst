...
As documented you should create/import your Celery app in ``tracpro/__init__.py`` so that you
...
You will also need to add the ``BROKER_URL`` to the ``tracpro.settings.production`` so
